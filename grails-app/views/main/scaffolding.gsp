                            ...
                            <div class="menu_wrap">
                                <ul class="nav sf-menu LavaLamp">
                                    ...
                                    <li class="sub-menu current"><a href="javascript:{}">Features</a>
                                        <ul>
                                            <li class="current"><a href="${createLink(controller: 'main', action: 'scaffolding')}"><span>-</span>Scaffolding</a></li>
...
<div class="breadcrumb">
    <a href="${createLink(controller: 'main', action: 'index')}">Home</a><span>/</span>Scaffolding
</div>
<!-- Grid system
            ================================================== -->
