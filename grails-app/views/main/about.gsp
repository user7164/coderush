...
<div class="top_line">
    <div class="wrap">
        <div class="container">
            <div class="row">
                <div class="span6"><div class="logo"><a href="${createLink(controller: 'main', view: 'index')}"><img src="images/logo.png" alt="" /></a></div></div>
                <div class="span6">
                    <div class="follow_us">
                        <ul>
...
<div id="footer">
    <div class="wrap">
        <div class="container footer_bord">
            <div class="row">
                <div class="span3">
                    <a class="foot_logo" href="${createLink(controller: 'main', view: 'index')}" alt=""><img src="images/foot_logo.png" /></a>
